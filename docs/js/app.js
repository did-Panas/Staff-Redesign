(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-portf")) new swiper_core_Swiper(".slider-portf", {
        ...
        if (document.querySelector(".blog-tabs__slider")) new swiper_core_Swiper(".blog-tabs__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".careers__slider")) new swiper_core_Swiper(".careers__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".slider-why__slider")) new swiper_core_Swiper(".slider-why__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
        ...
        if (document.querySelector(".slider-how__slider")) new swiper_core_Swiper(".slider-how__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".slider-mserv__slider")) new swiper_core_Swiper(".slider-mserv__slider", {
    ...
    function getSlideLink() {
        ...
        for (const link of slidesLinks) if (link.closest(".slider-portf__slide.swiper-slide-active")) btn.href = link.href;
    }
    window.addEventListener("load", (function(e) {
        initSliders();
    }));
